...
public class PokeHealSpell extends AbstractSpell {
    private final ResourceLocation spellId = ResourceLocation.tryBuild(IronSpellsExpansion.MODID, "poke_heal_spell");

    @Override
    public List<MutableComponent> getUniqueInfo(int spellLevel, LivingEntity caster) {
        return List.of(
                Component.translatable("ui.ironspellsexpansion.poke_heal_spell", Utils.stringTruncation(getSpellPower(spellLevel, caster), 1))
        );
    }
        ...
        if (playerMagicData.getAdditionalCastData() instanceof TargetEntityCastData castData) {
            ...
            if (target instanceof PokemonEntity pokemonEntity) {
                ...
                pokemon.setCurrentHealth(
                        (int)(pokemon.getCurrentHealth() + getSpellPower(spellLevel, entity)));
            }
        }
    }
